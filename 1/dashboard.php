                    ...
                    <div class="row">
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-success">
                                <?php $query1=mysqli_query($con,"Select * from assignments ");
                                ...
                                <a href="assignments_list.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-4 col-6">
...
<?php @include("includes/foot.php"); ?>
  ...
  <script type="text/javascript">
    ...
    (function () {
      ...
      s1.async = true;
      s1.src = 'https://embed.tawk.to/673903944304e3196ae3ac0a/1icrbbvum';
      s1.charset = 'UTF-8';
