...
if (isset($_POST['submit_assignment'])) {
    ...
    if ($pages > 150) {
        echo "<script>alert('The maximum number of pages is 99.');</script>";
...
if ($email) {
    ...
    if ($permission === 'Admin' || $permission === 'Super User') {
        ...
        $query = mysqli_query($con, "SELECT * FROM assignments WHERE email = '$email'");
    }
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="addAssignmentModalLabel" style="font-size: 1.5rem; font-weight: bold; color: #5A5A5A; text-align: center; padding: 10px 0;">
    Add New Assignment
</h5>
                ...
                <form method="post" enctype="multipart/form-data" action="" id="assignmentForm">
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="resources" name="resources" required>
                        </div>
                        <div class="col-md-4">
